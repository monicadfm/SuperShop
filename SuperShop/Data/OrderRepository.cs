...
namespace SuperShop.Data
{
    public class OrderRepository : GenericRepository<Order>, IOrderRepository
    {
        ...
        public async Task AddItemToOrderAsync(AddItemViewModel model, string userName)
        {
            ...
            var orderDetailTemp = await _context.OrderDetailTemp.Where(odt => odt.User == user && odt.Product == product).FirstOrDefaultAsync();
        ...
        public async Task<IQueryable<OrderDetailTemp>> GetDetailTempsAsync(string userName)
        {
            ...
            return _context.OrderDetailTemp.Include(p => p.Product).Where(o => o.User == user).OrderBy(o => o.Product.Name);
        }
